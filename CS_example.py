...
# model = MLP([dataset.num_features, 200, 200, dataset.num_classes], dropout=0.5, norm="batch_norm", act_first=True).to(device)
model = MLP([dataset.num_features, dataset.num_classes], dropout=0.5).to(device)
...
print(y_soft.shape, y_train.shape, train_idx.shape, (DAD.size(0), DAD.size(1)))
print(y_soft.dtype, y_train.dtype, train_idx.dtype, DAD.dtype)
print(type(y_soft), type(y_train), type(train_idx), type(DAD))
